...
public class NewPokemon extends JFrame{
    ...
    public NewPokemon(Trainer trainer){
        ...
        JRadioButton Jigglypuff = new JRadioButton("Jigglypuff");
        JRadioButton Psyduck = new JRadioButton("Psyduck");
        ...
        file[0] = new File("Pikachu.jpg");
        file[1] = new File("Jigglypuff.jpg");
        file[2] = new File("Psyduck.jpg");
        ...
        okButton.addActionListener(new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
                if (name.getText().length() == 0||((Pikachu.isSelected() == false ) && (Jigglypuff.isSelected() == false) && (Psyduck.isSelected() == false))){
                }
                else{
                ...
                else if(name.getText() != "" && Pikachu.isSelected()){
                    trainer.addP();
                    trainer.slot().get(0).Name(name.getText());
                    trainer.slot().get(0).poke(0,1);
                   
                }
                else if(name.getText() != "" && Jigglypuff.isSelected()){
                    trainer.addP();
                    trainer.slot().get(0).Name(name.getText());
                    trainer.slot().get(0).poke(1,1);
                   
                }
                else if(name.getText() != "" && Psyduck.isSelected()){
                    trainer.addP();
                    trainer.slot().get(0).Name(name.getText());
